...
def select_name_and_series_subgenres_of_authors
  "SELECT authors.name, subgenres.name FROM authors INNER JOIN series ON series.author_id = author.id INNER JOIN subgenres ON series.subgenre_id = subgenre.id;"
end
